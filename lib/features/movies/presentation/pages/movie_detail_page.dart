...
//               final isInWatchlist =
//                   lastValidState.movies.any((m) => m.id == widget.movie.id);
//               return _buildWatchlistButtonContent(
//                   context, isInWatchlist, false,);
//             }
...
//       BuildContext context, bool isInWatchlist, bool isLoading,) {
//     return SizedBox(
//       width: double.infinity,
//       child: ElevatedButton.icon(
//         onPressed: isLoading
    ...
    return BlocConsumer<WatchlistBloc, WatchlistState>(
      ...
      builder: (context, state) {
        return state.when(
          ...
          error: (message) {
            // Show error in listener, keep last valid state for UI
            final lastValidState = context.read<WatchlistBloc>().state;
            if (lastValidState is Loaded) {
